...
0. Dockerizing the whole project and running it on local computer and also with a domain name
    0.0 Initially just using Mongodb
    https://www.digitalocean.com/community/tutorials/how-to-set-up-a-scalable-mongodb-database

1. Set up scalable mongodb servers 
    1.1 First on local machine (Write sh code)
    1.2 For amazon Elastic Beans

2. Set up scalable Amazon s3 buckets
    2.1 Sh code

3. Creating a CI/CD

4. Jenkins and Amazon terraforms

5. oauth authentications
